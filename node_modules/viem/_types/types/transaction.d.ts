...
export type Transaction<quantity = bigint, index = number, isPending extends boolean = boolean> = OneOf<TransactionLegacy<quantity, index, isPending> | TransactionEIP2930<quantity, index, isPending> | TransactionEIP1559<quantity, index, isPending> | TransactionEIP4844<quantity, index, isPending>>;
...
export type TransactionRequestLegacy<quantity = bigint, index = number, type = 'legacy'> = TransactionRequestBase<quantity, index> & {
    accessList?: undefined;
    blobs?: undefined;
    type?: type | undefined;
} & ExactPartial<FeeValuesLegacy<quantity>>;
export type TransactionRequestEIP2930<quantity = bigint, index = number, type = 'eip2930'> = TransactionRequestBase<quantity, index> & {
    accessList?: AccessList | undefined;
    blobs?: undefined;
    type?: type | undefined;
} & ExactPartial<FeeValuesLegacy<quantity>>;
export type TransactionRequestEIP1559<quantity = bigint, index = number, type = 'eip1559'> = TransactionRequestBase<quantity, index> & ExactPartial<FeeValuesEIP1559<quantity>> & {
    accessList?: AccessList | undefined;
    blobs?: undefined;
    type?: type | undefined;
};
export type TransactionRequestEIP4844<quantity = bigint, index = number, type = 'eip4844'> = RequiredBy<TransactionRequestBase<quantity, index>, 'to'> & {
    accessList?: AccessList | undefined;
...
export type TransactionRequest<quantity = bigint, index = number> = OneOf<TransactionRequestLegacy<quantity, index> | TransactionRequestEIP2930<quantity, index> | TransactionRequestEIP1559<quantity, index> | TransactionRequestEIP4844<quantity, index>>;
...
export type TransactionSerialized<type extends TransactionType = TransactionType, result = (type extends 'eip1559' ? TransactionSerializedEIP1559 : never) | (type extends 'eip2930' ? TransactionSerializedEIP2930 : never) | (type extends 'eip4844' ? TransactionSerializedEIP4844 : never) | (type extends 'legacy' ? TransactionSerializedLegacy : never)> = IsNever<result> extends true ? TransactionSerializedGeneric : result;
...
export type TransactionSerializableLegacy<quantity = bigint, index = number> = TransactionSerializableBase<quantity, index> & {
    accessList?: undefined;
    blobs?: undefined;
    blobVersionedHashes?: undefined;
...
export type TransactionSerializableEIP2930<quantity = bigint, index = number> = TransactionSerializableBase<quantity, index> & {
    accessList?: AccessList | undefined;
    blobs?: undefined;
    blobVersionedHashes?: undefined;
    chainId: number;
...
export type TransactionSerializableEIP1559<quantity = bigint, index = number> = TransactionSerializableBase<quantity, index> & {
    accessList?: AccessList | undefined;
    blobs?: undefined;
    blobVersionedHashes?: undefined;
    chainId: number;
...
export type TransactionSerializableEIP4844<quantity = bigint, index = number> = TransactionSerializableBase<quantity, index> & {
    accessList?: AccessList | undefined;
    chainId: number;
    sidecars?: readonly BlobSidecar<Hex>[] | false | undefined;
    type?: 'eip4844' | undefined;
    yParity?: number | undefined;
} & ExactPartial<FeeValuesEIP4844<quantity>> & OneOf<{
    blobs?: readonly Hex[] | readonly ByteArray[] | undefined;
    blobVersionedHashes: readonly Hex[];
} | {
    blobs: readonly Hex[] | readonly ByteArray[];
...
export type TransactionSerializable<quantity = bigint, index = number> = OneOf<TransactionSerializableLegacy<quantity, index> | TransactionSerializableEIP2930<quantity, index> | TransactionSerializableEIP1559<quantity, index> | TransactionSerializableEIP4844<quantity, index>>;
